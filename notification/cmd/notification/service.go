...
import (
	...
	"notification/pkg/notification/infrastructure/integrationevent"
	...
	return &cli.Command{
		...
		Action: func(c *cli.Context) error {
			...
			userPublicAPIServer := transport.NewPaymentInternalAPI(
				appservice.NewNotificationService(uow, luow, eventDispatcher),
			)
			...
			errGroup.Go(func() error {
				...
				notificationinternal.RegisterNotificationInternalServiceServer(grpcServer, userPublicAPIServer)
